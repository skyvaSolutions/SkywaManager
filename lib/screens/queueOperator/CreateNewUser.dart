...
class _CreateNewUserState extends State<CreateNewUser> {
  ...
  void updateUserPost(
    ...
    //Sending sms to number which is added by admin
    // if (isAdding) {
    //   print('adding');
    //   final smsParams = {
    //     'phoneNumber': phone,
    //     'body': 'Hello $userName, a new business has added you. Join through skywa'
    //   };
    //
    //   String smsBody = json.encode(smsParams);
    //
    //   await http.post(
    //     Uri.parse('https://shoeboxtx.veloxe.com:36251/api/sendSMSPost'),
    //     body: smsBody,
    //     headers: {"Content-Type": "application/json"},
    //   );
    //   print('reached');
